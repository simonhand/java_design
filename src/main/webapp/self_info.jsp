	         ...
	         <table class="table table-striped table-hover table-bordered">
				...
				<c:forEach var="address" items="${addList}" varStatus="i" >
					<tr>
						...
						<td>
							<button onclick="deleteAddr(${address.id})" class="btn btn-danger btn-sm" style="width: 60px">删除</button>&nbsp;&nbsp;
							<button class="btn btn-default btn-sm" data-toggle="modal" data-target="#myModal${address.id}" style="width: 60px">修改</button>&nbsp;&nbsp;
							<!-- 弹出模态框 -->
		...
		<div class="container" style="width:960px;">
			...
			<form action="userservlet?method=addAddress" method="post" class="form-horizontal">
				...
				<div class="form-group col-md-12">
					...
					<div style="color:red;position: relative;left: 110px;font-size: 20px" ><strong>${msg}</strong></div>
				</div>
